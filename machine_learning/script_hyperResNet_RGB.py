...
past_model="CNN_"+dataset+"_*.hdf5"
final_model="CNN_"+dataset+"_final.h5"
...
hypermodel = HyperResNet(input_shape=input_shape, classes=number_of_classes)
...
tuner = RandomSearch(
    ...
    overwrite=True,
    directory="/home/lorde/AmandaTrials_2",
    project_name="Hyper2"
    )
tuner.search_space_summary()
tuner.search(train_generator, steps_per_epoch=(nb_train_samples // batch_size),epochs=5, validation_data=validation_generator, validation_steps= (nb_validation_samples // batch_size), verbose=1)
